    ...
    <div className="flex flex-col gap-10 text-black">
      ...
      <div className="flex flex-col gap-4 md:px-5">
        ...
        <h3 data-aos="fade-up" className="text-xl font-medium mt-2">
          ELIXIRAI - Crafting Digital Experiences
        </h3>
        ...
        <p data-aos="fade-up" className="description">
          ...
          ELIXIRAI, we build custom websites that are crafted to meet the unique
          needs of your business. Whether you need a dynamic corporate site, an
          eCommerce platform, or a simple landing page, we ensure your website
          provides a seamless user experience, no matter the device.
        </p>
      </div>
