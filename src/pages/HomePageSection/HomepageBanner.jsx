      ...
      <div className="relative grid md:grid-cols-2 gap-5 items-center wrapper w-full">
        <div className="text-center flex flex-col items-start sm:text-left">
          <div className="text-center mb-8">
            <h1 className="main-heading text-black ">YOUR VISION</h1>
            <h1 className="main-heading text-black ">+</h1>
            <h1 className="main-heading text-black ">OUR CODE</h1>
            <h1 className="main-heading text-black ">- Let’s Create Magic</h1>
          </div>
